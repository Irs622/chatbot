              ...
              return (
                <div
                  ...
                  className={`p-3.5 cursor-pointer text-xs transition-colors flex items-start justify-between gap-3 ${
                    isSelected ? 'bg-sky-50 border-l-4 border-l-[#005DAD]' : 'hover:bg-slate-50'
                  }`}
                >
          ...
          {selectedChunk ? (
            <div className="space-y-4">
              <div className="border-b border-slate-100 pb-3 flex items-start justify-between">
                <div>
                  <span className="text-[10px] uppercase font-bold text-[#005DAD] bg-sky-50 px-2.5 py-1 rounded-md">
